...
Background.headparticle = function() {   
   ...
   Background.camera = new THREE.PerspectiveCamera( 55, site.Width / site.Height, 1, 2000 );
   ...
   function onDocumentMouseMove( event ) {
      mouseX = ( windowHalfX - event.clientX  ) / 2;  //edited on 21/6/2024
      mouseY = ( windowHalfY - event.clientY  ) / 2;  //edited on 21/6/2024
   }
